...
# Board-specific init
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/ueventd.pw28.rc:root/ueventd.pw28.rc \
    $(LOCAL_PATH)/320_480logo.rle:root/320_480logo.rle \
    $(LOCAL_PATH)/320_480logo.rle:root/initlogo.rle \
    $(LOCAL_PATH)/init.zero.rc:root/init.zero.rc
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/prebuilt/wificit.sh:system/bin/wificit.sh \
    $(LOCAL_PATH)/prebuilt/nvram.txt:system/etc/wifi/nvram.txt \
    vendor/geeksphone/zero/proprietary/lib/hw/sensors.default.so:system/lib/hw/sensors.default.so \
    $(LOCAL_PATH)/AutoVolumeControl.txt:system/etc/AutoVolumeControl.txt \
